...
[![Go
Reference](https://pkg.go.dev/badge/github.com/elnerd/golang-jwt-parser/v5.svg)](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5)
...
```sh
go get -u github.com/elnerd/golang-jwt-parser/v5
```

2. Import it in your code:

```go
import "github.com/elnerd/golang-jwt-parser/v5"
```
...
See [the project documentation](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5)
for examples of usage:

* [Simple example of parsing and validating a
  token](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5#example-Parse-Hmac)
* [Simple example of building and signing a
  token](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5#example-New-Hmac)
* [Directory of
  Examples](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5#pkg-examples)
...
pkg.go.dev](https://pkg.go.dev/github.com/elnerd/golang-jwt-parser/v5). Additional
